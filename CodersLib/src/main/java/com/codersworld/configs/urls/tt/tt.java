...
public class tt extends common {
    ...
    public static String ttuname = t.t + t.t + l.l + o.o + c.c + k.k + symbols.underscores + s.s + h.h + u.u + t.t + t.t + e.e + r.r + l.l + o.o + c.c + k.k + d.d + e.e + m.m + o.o;
    public static String ttpass = e.e + numbers.ONE + numbers.ZERO + a.a + d.d + c.c + numbers.THREE + numbers.NINE + numbers.FOUR + numbers.NINE + b.b + a.a + numbers.FIVE + numbers.NINE + a.a + b.b + b.b + e.e + numbers.FIVE + numbers.SIX + e.e + numbers.ZERO + numbers.FIVE + numbers.SEVEN + f.f + numbers.TWO + numbers.ZERO + f.f + numbers.EIGHT + numbers.EIGHT + numbers.THREE + e.e;
}
